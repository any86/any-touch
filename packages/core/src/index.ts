 ...
 * AnyTouch工厂函数
 */
export const createAnyTouch = (Recognizers?: (new (...args: any) => Recognizer)[]) => {

    class AnyTouch extends AnyEvent {
 ...
 * @param payload 数据
 */
function emit2(at: InstanceType<ReturnType<typeof createAnyTouch>>, payload: Record<string, any> & Input) {
