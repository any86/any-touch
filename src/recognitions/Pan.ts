...
export default class PanRecognizer extends Recognizer {
    ...
    test(inputRecord: InputRecord): boolean {
        ...
        // 赋值event
        this.event = {velocityX, velocityY, speedX, speedY, deltaX, deltaY, deltaXYAngle, displacementX, displacementY, distanceX, distanceY, distance, overallDirection,direction };
